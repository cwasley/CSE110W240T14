...
=======
>>>>>>> 502e884edcf24b11b67208a304cc017ab8e604f3
    }
    ...
    private void loadData() {
        ...
        for(Department department : HomeScreen.depart){
            ...
            for(Course course : department.courses){
               ClassInfo UCSD_class = new ClassInfo(department.name+" "+course.name, " ", " ");
                listOfClasses.add(UCSD_class);
            }
            ClassList UCSD_classList = new ClassList(department.name, listOfClasses);
